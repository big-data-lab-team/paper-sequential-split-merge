...
def get_avg_mwrites(input_file, output_file):
    read_times_3g = []
    write_times_3g = []
    seek_times_3g = []
...
def main():
    get_avg_mwrites(input_file_mwrites_ssd, output_file_mwrites_ssd)
    get_avg_mwrites(input_file_mwrites_hdd, output_file_mwrites_hdd)
