...
def get_avg_var_mwrites_naive(input_file_mwrites, input_file_naive, output_file, disk):
    read_times_3g = []
    write_times_3g = []
    seek_times_3g = []
    ...
    with open(input_file_mwrites, 'r') as f:
        for line in f:
            if '#' not in line:
                items = line.split(' ')
                # 3g
...
def main():
    get_avg_var_mwrites_naive(input_file_mwrites_ssd, input_file_naive_ssd, output_file_mwrites_ssd, disk="ssd")
    get_avg_var_mwrites_naive(input_file_mwrites_hdd, input_file_naive_hdd, output_file_mwrites_hdd, disk="hdd")
