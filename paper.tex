...
\begin{abstract}
  ...
  resolution images, due to seek times. We introduce and
  ...
  Clustered reads do not, due to their use of negative seeking. We
...
We generated NiFTI slabs of size 3850x3025x28 from the reconstructed
...
reads) and 0.9\% (Buffered slices), explained by the fact
...
16~GB. Buffered slices provide no speed-up compared
to Naive slices.
