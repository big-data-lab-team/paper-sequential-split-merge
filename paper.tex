...
%% \begin{equation*}
%%   m_{case 1}' = \floor*{\frac{m}{d^3b}}; m_{case 2}' = \floor*{\frac{m}{d^3b\sqrt[3]{n}}}; m_{case 3}' = \floor*{\frac{m}{d^3b\sqrt[3]{n}^2}}
%% \end{equation*}
%% which gives:
\begin{equation*}
  m_1' = \floor*{\frac{mn}{Rb}};
  m_2' = \floor*{\frac{m\sqrt[3]{n}^2}{Rb}};
  m_3' = \floor*{\frac{m\sqrt[3]{n}}{Rb}}
\end{equation*}
