...
the merging time, for Multiple reads and Naive slices. As explained
before, Clustered reads could only be applied to compressed data while
in Case 3, i.e., for 16~GB, and Naive blocks could not be
used. Compression dramatically slows down merging time for all
algorithms \todo{Check that once all results are available}.
...
images since they do not need to seek in it. Nonetheless, in our
experimental setup compression drastically slowed down merging
algorithms and proved of little use unless storage was limited.
