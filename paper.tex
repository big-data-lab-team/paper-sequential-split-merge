...
\begin{figure}[h]
  \centering
  \includegraphics[width=\columnwidth]{figures/times-hdd.pdf}\\
  \includegraphics[width=\columnwidth]{figures/times-ssd.pdf}
  \hfill
  ...
  % Gnuplot file: scripts/experiment/number_of_seeks.gnuplot
